        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
            ...
            <div className="text-center lg:text-left">
              {/* Badge */}
              <div className="inline-flex items-center gap-3 rounded-full bg-white/10 backdrop-blur-sm px-5 py-2.5 mb-8">
                <div className="flex items-center gap-2">
                  <div className="h-2 w-2 rounded-full bg-green-400 animate-pulse" />
                  <span className="text-sm font-medium text-white/90">{locale === 'is' ? 'Opið 24/7' : 'Open 24/7'}</span>
                </div>
                <div className="h-4 w-px bg-white/20" />
                <span className="text-sm text-white/70">Keflavík, Iceland</span>
              </div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                <Link
                  href={`/${locale}/booking`}
                  className="group inline-flex items-center justify-center gap-2 rounded-xl bg-white px-6 py-3.5 text-base font-semibold text-[#255da0] shadow-lg transition-all hover:bg-white/90 hover:shadow-xl"
                >
                ...
                <Link
                  href="#how-it-works"
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-white/10 backdrop-blur-sm px-6 py-3.5 text-base font-semibold text-white transition-all hover:bg-white/20"
                >
              ...
              {/* Trust indicators */}
              <div className="mt-10 flex flex-wrap gap-x-6 gap-y-3 justify-center lg:justify-start">
                {[
