    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center px-4 py-12">
      <div className="max-w-lg w-full text-center">
          ...
          <div className="relative h-40 flex items-center justify-center">
            ...
            <div className="absolute inset-x-0 bottom-0 h-24 bg-slate-200 rounded-2xl overflow-hidden">
              ...
              <div className="absolute bottom-2 inset-x-0 flex justify-around px-8">
                ...
                <span className="text-xs font-bold text-red-400">P?</span>
            ...
            <div className="relative z-10">
              <div className="relative">
                <div className="w-20 h-20 bg-[#255da0] rounded-2xl flex items-center justify-center shadow-lg shadow-[#255da0]/30">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/en"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#255da0] text-white font-semibold rounded-xl hover:opacity-90 transition-all shadow-lg shadow-[#255da0]/25"
          >
